...
1. Run the following command to run the function app project:
   ...
   > Run the below command in the terminal, Open the new terminal and Perform steps 2 & 3:
...
1. Run the following command to test the **POST** REST API call against `http://localhost:7071/api/echo` with the HTTP request body set to a numeric value of **3**:

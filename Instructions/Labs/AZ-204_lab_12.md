...
1. On the **Create a storage account** blade, on the **Basics** tab, perform the following actions, and then select **Next: Advanced >**:
   ...
   | **Region** drop-down list         | Select **(US) West US (2)**.                                     |
...
1. Click on **Review + create** tab, review the options that you selected during the previous steps.
...
1. In the Azure portal, select the **Cloud Shell** icon ![Cloud Shell icon](./media/az204_lab_CloudShell.png) to open a the Cloud Shell. Select **Bash** in the **Cloud Shell** menu.

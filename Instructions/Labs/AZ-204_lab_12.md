...
1. On the **Create a storage account** blade, on the **Basics** tab, perform the following actions, and then select **Next: Advanced >**:
   ...
   | **Resource group** drop-down list        | Select **MarketingContent-<inject key="DeploymentID" enableCopy="false"/> (2)** 
   | **Storage account name** text box | Enter **contenthost<inject key="DeploymentID" enableCopy="false"/> (3)**                            |
   ...
   | **Redundancy** drop-down list     | Select **Locally-redundant storage (LRS) (6)**.                  |
    ...
    ![Screenshot displaying the configured settings on the Create a storage account blade](./media/3012025(8).png)
...
1. On the **Create Web App** blade, on the **Basics** tab, perform the following actions, and then select **Next: Container**:
   ...
   | --------------------------------- | ------------------------------------------------------------ |
   | **Subscription**    | Retain the default value **(1)**                       |
   | **Resource group** drop-down list | Select **MarketingContent-<inject key="DeploymentID" enableCopy="false"/> (2)** in the list                    |
   | **Name** text box                 | Enter **landingpage<inject key="DeploymentID" enableCopy="false"/> (3)**                           |
   | **Secure unique default hostname** | **Disabled (4)** |
   | **Publish** section               | Select **Container (5)**                                 |
   | **Operating System** section      | Select **Linux (6)**                                            |
   | **Region** drop-down list         | Select **West US (7)**                                         |
   | **Linux Plan (East US)** section  | Select **Create new**. In the **Name** text box, enter **MarketingPlan**, and then select **OK (8)**. |
   | **Pricing plan** section          | Select **Premium V3 P1V3 (9)**                               |

   The following screenshot displays the configured settings on the **Create Web App** blade.

   ![Screenshot displaying the configured settings on the Create a storage account blade](./media/3012025(9).png)

1. On the **Container** tab, perform the following actions, and then select **Review + create (6)**:

    | Setting | Action |
    | -- | -- |
    | **Sidecar support (preview)** | Select **Disabled (1)** |
    | **Image Source**  | Select **Other Container registries (2)** |
    | **Access Type** drop-down list | Select **Public (3)** |
    | **Registry server URL** | Enter `https://index.docker.io` **(4)** |
    | **Image and tag** text box | Enter **microsoftlearning/edx-html-landing-page:latest (5)** |

   The following screenshot displays the configured settings on the **Container** tab.

   ![Screenshot displaying the configured settings on the Create a storage account blade](./media/3012025(10).png)
...
1. On the **CDN profile** blade, on the **Basics** tab, perform the following actions, and then select **Review + create (4)**:
   ...
   | **Name** text box                           | Enter **contentdeliverynetwork (2)**.        |
   | **Region** text box                         | Retain the default value (Global).       |
   | **Pricing tier** drop-down list             | Select **Microsoft CDN (classic) (3)**       |
   ...
   The following screenshot displays the configured settings on the **CDN profile** blade.
    ...
    ![Screenshot displaying the configured settings on the Create a storage account blade](./media/3012025(11).png)
...
1. In the **Add an endpoint** pop-up dialog box, perform the following actions, and then select **Add (7)**:
   ...
   <validation step="9faa32a9-e27f-4725-a64a-4c7783fb033b" />
...
1. Select **Apply (3)** to close the pop-up dialog and return to the **App settings** section.

   ![Screenshot displaying the configured settings on the Create a storage account blade](./media/3012025(12).png)
   
1. In the **App settings** tab, select **+ Add**. Enter the following information in the **Add/Edit application setting** pop-up dialog:

   | Setting                               | Action                                                       |
   | ------------------------------------- | ------------------------------------------------------------ |
   | **Name** text box                     | Enter **CDNVideoEndpoint (1)**                                  |
   | **Value** text box                    | Enter the **URI** value of the **video** container in the **contenthost<inject key="DeploymentID" enableCopy="false"/>** storage account that you recorded previously in this lab **(2)** |
   | **Deployment slot setting** check box | Retain the default value                                               |

1. Select **Apply (3)** to close the pop-up dialog and return to the **App settings** section.

   ![Screenshot displaying the configured settings on the Create a storage account blade](./media/3012025(13).png)

...
4. After installing C# extension, close the Visual Studio code.
...
1. In the Azure portal, use the **Search resources, services, and docs** text box to search for **Container Registry** and select it.

1. Open the **Container registries** that you have created.

1.  From the **Container Registry** blade, in the **Services** section, select the **Repositories**. In the **Repositories** section, select the **ipcheck** container image repository.
...
1. Navigate back to **Home > Container registries > Container registry** (created by you).
   
1.  On the **Access Keys** blade, in the **Admin user** section, select the **checkbox** (2).

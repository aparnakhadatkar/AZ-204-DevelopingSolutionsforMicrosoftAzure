...
1. Select the **Monitoring** tab and select **Yes (1)** in the **Enable Application Insights** section. Select **applicationinsight (2)** for **Application Insights**. Then select **Review + create (3)**.
...
1. Open the GitHub repository that you created in the previous task, and select the **Actions (1)** from the top menu. On the **Actions** tab, under the **All workflows**, select the **Add or update the Azure App Service build and deployment workflow config (2)** to see the build and deployment process.

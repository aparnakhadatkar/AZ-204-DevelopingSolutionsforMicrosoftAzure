...
1. Close the **Startup.cs** file without making any modifications.
   ...
   > **Note**: Navigate to the path **C:\AllFiles\AZ-204-DevelopingSolutionsforMicrosoftAzure-master\Allfiles\Labs\04\Solution\AdventureWorks\AdventureWorks.Web\Configuration\Settings.cs**, open the file and make the necessary changes matching with the below code **Save** it.

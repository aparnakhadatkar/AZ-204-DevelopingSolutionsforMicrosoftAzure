...
1. On the **Create a storage account** blade, on the **Basics** tab, perform the following actions:
   ...
   ![Screenshot displaying the configured settings on the Create a storage account blade](./media/a10.png)
...
1. On the **Create a secret** blade, perform the following actions, and then select **Create (5)**:
   ...
   The following screenshot displays the configured settings on the **Create a secret** blade.
    ...
    ![Screenshot displaying the configured settings on the Create a secret blade ](./media/a12.png)

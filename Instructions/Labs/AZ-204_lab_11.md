...
1. Now enter the following **Password** and click on **Sign in**.
   ...
   * Password: <inject key="AzureAdUserPassword"></inject>
      ...
      > **Note**: Click on **No**, if stay signed in window Pops-up and select **Cancel** on Welcome to Microsoft Azure Window.
...
5.  Select **Create** to create the **Log Analytics Workspace** by using your specified configuration.
    ...
    > **Note**: Wait for the creation task to complete before you proceed with next task.
...
1.  At the terminal prompt, run the following command to sign in to your Azure subscription by using Azure PowerShell ISE:
    ...
    > **Note**: If prompted, click on **Work or School account** and enter the Azure credentials provided in the environment to autheniticate.

...
1. On the **Create a resource** blade, in the **Search services and marketplace** text box, search for **Event Grid Topics** and select it.
...
1. On the **Create a resource** blade, in the **Search services and marketplace** text box, search for **App Services**, and select it.
...
1. On the **Container** tab, perform the following actions, and select **Review + create**:
    ...
    | **Registry server URL**  | Select **[Public](https://index.docker.io)** |

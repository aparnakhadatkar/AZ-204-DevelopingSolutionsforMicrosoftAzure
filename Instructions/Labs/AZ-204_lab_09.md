...
1. On the Azure Portal, in the in the **Search services and marketplace** text box, search for **App Services**, and select it.
...
1. On the **Container** tab, perform the following actions, and click on **Review + create (5)**:
    ...
    | **Registry server URL**  | Select **[Public](https://index.docker.io)** **(3)** |
...
1. Select **Kill Terminal** or the **Recycle Bin** icon to close the currently open terminal and any associated processes.
    ...
    <validation step="7eb4bfc6-03d9-4b10-8ec4-d2616ee66182" />
